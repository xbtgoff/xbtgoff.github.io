function getWeather() {
  ...
  if (location != "") {
    var url =
      ...
      location +
      "&appid=ee81ce813f90190bc192d957291399f4";
    fetch(url)
      ...
      .then((data) => {
        if (data.cod == "404") {
          ...
          if ("humidity" != "") {
            document.getElementById("humidity-label").style.visibility =
              "visible";
          }
          if ("wind" != "") {
          ...
          if ("description" != "") {
            document.getElementById("description-label").style.visibility =
              "visible";
          }
